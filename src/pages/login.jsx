...
export default function Login() {
  return (
    <>
      <section className="box-border flex h-screen flex-col bg-white lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        <main className="box-border flex flex-grow items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="box-border max-w-xl md:rounded-xl md:p-10 md:shadow-2xl md:shadow-tan lg:max-w-3xl">
            ...
            <Link
              to={"/"}
              className="group mt-4 flex w-fit text-blue-600 transition-all duration-300 hover:underline"
            >
              <i>
                <svg
