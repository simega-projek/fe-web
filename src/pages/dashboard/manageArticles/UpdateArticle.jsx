...
//     file: null,
//   });
//   const [debounceDescription] = useDebounce(formState.description, 3000);
//   const [messageError, setMessageError] = useState(null);
//   const [messageSuccess, setMessageSuccess] = useState(null);
//   const [loading, setLoading] = useState(false);
//   const [dataUpdate, setDataUpdate] = useState({});
...
//       formData.append("image", formState.image || originalImage);
//       formData.append("file", formState.file || originalFile);
...
//       }
//     },
//     [formState, originalImage, originalFile, id, onSuccess, onClose],
//   );
...
//       />
//     ),
//     [formState.description, handleEditorChange, loading],
//   );
