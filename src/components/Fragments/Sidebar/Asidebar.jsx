  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* <!-- MAX SIDEBAR--> */}
        <div
          className={`mt-20 flex ${!isSidebarOpen ? "ml-5 translate-x-40" : "w-full"} ${onListMenageObject ? "lg:overflow-y-auto lg:overflow-x-hidden lg:pb-5" : ""} scrollbar h-[calc(100vh)] flex-col space-y-2 text-white`}
        >
          <SidebarItem
            label={"Dashboard"}
            to={"dashboard"}
